 ...
 */
	...
	// Set session data
	function photoboard_notifications_set_session( $name, $value, $sanitize = null ) {
	...
	// Get session data
	function photoboard_notifications_get_session( $name, $unset = false ) {
	...
	function photoboard_notifications_get_url() {
	...
	function photoboard_notifications_get_site_domain() {
	...
	function photoboard_notifications_prepare_url( $url ) {
	...
	function photoboard_notifications_clean_url( $variable, $url ) {
	...
	function photoboard_notifications_has_letters( $string ) {
		return preg_match( '/[a-zA-Z]/', $string );
	}

	// Does string contain numbers?
	function photoboard_notifications_has_numbers( $string ) {
		return preg_match( '/\d/', $string );
	}

	// Does string contain special characters?
	function photoboard_notifications_has_special_chars( $string ) {
